...
print(paste(round(Learning_Rate,2),"%"))
...
Plot3 <- ggplot(PREDICTIONS_FINAL, aes(x=number_of_solar_panels, y=manufacturing_cost, color = PREDICTIONS_FINAL$color_range)) +
  geom_point() + scale_color_manual(values = c("Data" = "#32A287", "Predictions" = "#F0C987")) + theme_minimal()+ labs(title = "Experience Curve",subtitle = "Predictions", x="Number of Solar Pannels", y="Manufacturing Cost", caption = "Case Study 1", color = "") 
